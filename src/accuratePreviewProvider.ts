...
export class ImprovedQuarkdownPreviewProvider implements vscode.WebviewPanelSerializer {
    private _panels = new Map<string, vscode.WebviewPanel>();
    private _serverProcess: ChildProcess | null = null;
    private _serverPort = 8089;
    ...
    private async renderWithQuarkdown(document: vscode.TextDocument): Promise<string> {
    ...
    private adjustHtmlForWebview(html: string): string {
    ...
    private stopServerIfNeeded(): void {
